        ...
        <div className="uploads__form-wrap">
          ...
          >
            <label htmlFor="uploadsInput">
              ...
              <input
                className="uploads__inputTitle"
                id="uploadsInputTitle"
                name="uploadsInputTitle"
            ...
            <label htmlFor="uploadsInput">
              ...
              <textarea
                className="uploads__inputDesc"
                id="uploadsInputDesc"
                name="uploadsInputDesc"
            ...
            <div className="uploads__border">
              <button className="uploads__button" id="uploadsBtn" type="submit">
                PUBLISH
              </button>
              <button
                className="uploads__button uploads__button-delete"
                id="uploadsDeleteBtn"
